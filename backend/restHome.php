				...
				<div class="container main-menu">
					<div class="row align-items-center justify-content-center d-flex">
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          <li><a href="restHome.php">Profile</a></li>
			...
			function convName(uname) {
				...
				<?php
						...
						echo "
							...
							";
						$query = "SELECT Order_No as o, Customer_First_Name as r, Agent_First_Name as a, Agent_Phone_No as p from Customer NATURAL JOIN foodorder NATURAL JOIN Delivery NATURAL JOIN Agents WHERE Restaurant_FSSAI_No IN (SELECT Restaurant_FSSAI_No FROM foodorder WHERE Restaurant_FSSAI_No = $Id_req);";
					    ...
					    echo "<div class='container'><table cellpadding = 25>
					    		<tr>
					    			...
					    			<th>Customer_Name</th>
					    			<th>Agent_Name</th>
					    			<th>Agent_Phone_No</th>
					    			<th>Items_Ordered</th>
					    		</tr>";
					    while ($row = mysqli_fetch_assoc($res)) {
					    	$ord = $row['o'];
					    	$query2 = "SELECT Item_Name as i FROM Item NATURAL JOIN Ordered_Items WHERE Order_No=$ord;";
