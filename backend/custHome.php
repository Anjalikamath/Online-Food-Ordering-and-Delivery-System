				...
				<div class="container main-menu">
					<div class="row align-items-center justify-content-center d-flex">
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          <li><a href="custHome.php">Profile</a></li>
						  <li><a href="Rest.html">Browse</a></li>
			...
			function convName(uname) {
				...
				<br>
						...
						echo "
							...
							";
						$query = "SELECT Order_No as o, Restaurant_Name as r, Agent_First_Name as a, Agent_Phone_No as p from Restaurant NATURAL JOIN foodorder NATURAL JOIN Delivery NATURAL JOIN Agents WHERE Restaurant_FSSAI_No IN (SELECT Restaurant_FSSAI_No FROM foodorder WHERE Customer_Email_Id = '$Id_req');";
